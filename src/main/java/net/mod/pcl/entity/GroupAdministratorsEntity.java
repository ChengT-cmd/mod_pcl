...
import net.mod.pcl.item.IronclipItem;
...
public class GroupAdministratorsEntity extends PclModElements.ModElement {
	public static EntityType entity = null;
	public GroupAdministratorsEntity(PclModElements instance) {
		super(instance, 27);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(128).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f)).build("group_administrators")
						.setRegistryName("group_administrators");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -1, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("group_administrators_spawn_egg"));
	}
	...
	public static class CustomEntity extends ZombieEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(7, new LookAtGoal(this, GroupMembersEntity.CustomEntity.class, (float) 10));
			...
			this.goalSelector.addGoal(14, new MoveTowardsVillageGoal(this, 0.5));
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(IronclipItem.block, (int) (1)));
		}
