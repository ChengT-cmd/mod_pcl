...
package net.mod.pcl.entity;

import net.mod.pcl.gui.HithereGui;
import net.mod.pcl.block.PCL2Block;
...
public class GroupMembersEntity extends PclModElements.ModElement {
	public static EntityType entity = null;
	public GroupMembersEntity(PclModElements instance) {
		super(instance, 26);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f)).build("group_members")
						.setRegistryName("group_members");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -1, -16777216, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("group_members_spawn_egg"));
	}
	...
	public static class CustomEntity extends VillagerEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(6, new TemptGoal(this, 1, Ingredient.fromItems(new ItemStack(PCL2Block.block, (int) (1)).getItem()), false));
			...
			if (sourceentity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) sourceentity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Group Member");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new HithereGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
